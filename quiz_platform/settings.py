...
SECRET_KEY = 'django-insecure-ochtext*1w14!csj9z^ubw$amzlctmil9$izf8f+47b#-$!va4'
...
MIDDLEWARE = [
    ...
    'corsheaders.middleware.CorsMiddleware',         # ✅ Top (just after Security)
...
# Optional - If you're using CSRF cookies:
